...
def main():
    ...
    print(f"  전국 unit-쌍은 약 {pairs_total:,}개. 이만큼 비교하면 개별적으로 드문 일치도")
    print(f"  우연히 ~10건 나오는 게 정상이고(census_significance: 관측 8 ≈ 기대 ~10),")
    print(f"  실제 8건은 그보다 적다. → '쌍둥이여도 드물다'가 곧 '이상'은 아니다.")
